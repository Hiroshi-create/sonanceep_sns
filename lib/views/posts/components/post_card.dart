...
import 'package:sonanceep_sns/models/delete_post_model.dart';
...
class PostCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final DeletePostModel deletePostModel = ref.watch(deletePostProvider);
    ...
    return CardContainer(
      ...
      child: Column(
        children: [
                  ...
                  builder: (BuildContext innerContext) => CupertinoActionSheet(
                    actions: [
                      CupertinoActionSheetAction(
                        ...
                        child: const Text(editPostText),
                      ),
                      CupertinoActionSheetAction(
                        isDestructiveAction: true,
                        onPressed: () {
                          Navigator.pop(innerContext);
                          deletePostModel.showDeletePostDialog(context: context, mainModel: mainModel, postDoc: postDoc);
                        },
          ...
          Column(
            children: [
              PostCardContants(mainModel: mainModel, length: 400.0, post: post, text: post.text, videoPlayerController: mainModel.videoPlayerController),
            ],
          ),
          //いいね、コメント
          Padding(
