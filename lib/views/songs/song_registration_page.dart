...
class SongRegistrationPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {  // WidgetRef ref でグローバルに監視した橋を観測できる
    ...
    final duration = songRegistrationModel.duration;
    final position = songRegistrationModel.position;
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            //オケのファイルを取得
            songRegistrationModel.bytes == null
            ? ElevatedButton(
              onPressed: () async => await songRegistrationModel.onWavFileTapped(),
              child: const Text('Pick a wav file'),
            )
            : Column(
                ...
                Row(
                  ...
                  children: [
                    IconButton(
                      ...
                      onPressed: () async => await songRegistrationModel.play(),
                      iconSize: 48.0,
                    ...
                    IconButton(
                      ...
                      onPressed: () async => await songRegistrationModel.stop(),
                      iconSize: 48.0,
                    ...
                    //   onPressed: isPlaying || isPaused ?  () async => await songRegistrationModel.stop() : null,
                    //   iconSize: 48.0,
