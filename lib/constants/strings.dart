...
const String bpmSettingTitle = 'BPM';
const String songSectionsTitle = '小節数';
const String timeSignatureTitle = '拍子';
// texts
...
const String createPostText = '投稿を作成';
const String pastingImageText = '画像を貼り付ける';
const String pastingVideoText = '動画を貼り付ける';
const String pastingThumbnailText = 'サムネイルを貼り付ける';
const String uploadCancelText = 'アップロードを取り消す';
const String createPostDefaultSoundText = 'デフォルト音源を使用';
const String createPostClipSoundText = 'クリップしたサウンドを使用';
const String createPostOneShotText = '一発撮り';
const String createPostEditAfterShooting = '撮影後に編集をする';
const String createPostToEditText = '編集のみ';
const String editPostText = '投稿を編集する';
...
const String failedToGetContentsText = 'コンテンツの取得に失敗しました';
const String dawMuteText = 'M';
const String dawSoloText = 'S';
const String dawRecText = 'R';
// alert message
...
const String deletePostMsg = '投稿を削除しますが本当によろしいですか？';
...
const String errCreatedPostMsg = '投稿に失敗しました : ';
...
const String nothingWavFile = 'wavファイルが設定されていません。';
...
const String fileIsNotLongEnoughMsg = 'ファイルの長さが確認できません';
const String failedToRetrieveDataMsg = 'データの取得に失敗しました。';
// prefs key
...
const String singleSongImageURL = 'singleImageURL';
const String providesOffVocal = 'providesOffVocal';
// path
const String accentClickPath = 'assets/audios/accentClick.wav';
const String clickPath = 'assets/audios/click.wav';
// radio botann list
...
// daw timeSignature lsit
const List<String> phoneticValue = ['1', '2', '4', '8', '16', '32', '64'];
...
String returnWavFileName() => '${returnUuidV4()}.wav';

String returnSaveAssetsLocalPath({required String path, required String key}) => '$path/assets/$key.wav';
