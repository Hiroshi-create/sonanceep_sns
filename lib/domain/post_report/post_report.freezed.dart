...
//メインの報告内容
  ...
  @override
  String toString() {
    return 'PostReport(activeUid: $activeUid, createdAt: $createdAt, others: $others, reportContent: $reportContent, postCreatorUid: $postCreatorUid, passiveUserName: $passiveUserName, postDocRef: $postDocRef, postId: $postId, postReportId: $postReportId, text: $text, textLanguageCode: $textLanguageCode, textNegativeScore: $textNegativeScore, textPositiveScore: $textPositiveScore, textSentiment: $textSentiment)';
  }
