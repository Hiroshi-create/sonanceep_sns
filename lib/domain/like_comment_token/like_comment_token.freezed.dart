...
/// @nodoc
@JsonSerializable()
class _$LikeCommentTokenImpl
    with DiagnosticableTreeMixin
    implements _LikeCommentToken {
...
// const factory 違うクラスのインスタンスを返すことができるコンストラクタ
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'LikeCommentToken(activeUid: $activeUid, createdAt: $createdAt, passiveUid: $passiveUid, postCommentRef: $postCommentRef, postCommentId: $postCommentId, tokenId: $tokenId, tokenType: $tokenType)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'LikeCommentToken'))
