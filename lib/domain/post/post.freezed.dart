...
// const factory 違うクラスのインスタンスを返すことができるコンストラクタ
  ...
  @override
  String toString() {
    return 'Post(createdAt: $createdAt, hashTags: $hashTags, imageURL: $imageURL, videoURL: $videoURL, thumbnailURL: $thumbnailURL, likeCount: $likeCount, text: $text, textLanguageCode: $textLanguageCode, textNegativeScore: $textNegativeScore, textPositiveScore: $textPositiveScore, textSentiment: $textSentiment, commentCount: $commentCount, postId: $postId, reportCount: $reportCount, muteCount: $muteCount, uid: $uid, userName: $userName, userNameLanguageCode: $userNameLanguageCode, userNameNegativeScore: $userNameNegativeScore, userNamePositiveScore: $userNamePositiveScore, userNameSentiment: $userNameSentiment, userImageURL: $userImageURL, updatedAt: $updatedAt)';
  }
